...
| **10-25**   | `standalone` | `2.0.14` | `DB_URL` 환경 변수 지원 (Turso, Bun SQLite 등)        |
...
| **11-12**   | `standalone` | `2.0.17` | Bun SQL 기반 SQLite로 변경 (Postgres/MySQL 연결 가능*)    |
...
| **12-14**   | `server`     | `4.0.5`  | 버그 수정 (#144) - **최신 버전**                          |

> **\*** Postgres/MySQL은 Bun SQL 레이어로 연결 가능하지만, 공식 지원/테스트 대상은 아닙니다.
