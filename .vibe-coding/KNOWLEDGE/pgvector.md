...
| 날짜 (UTC) | 버전  | 상태         | 핵심 요약                                                                    |
| :--------- | :---- | :----------- | :--------------------------------------------------------------------------- |
| 2025-09-04 | 0.8.1 | 기간 내 포함 | Postgres 18 rc1 지원, binary_quantize 성능 최적화                            |
...
- 성능: binary_quantize 함수 로직이 개선되어 해당 인덱스를 타는 쿼리 속도가 빨라졌다.
...
- strict_order: 거리 순서를 엄격하게 지키며 탐색한다. 정확도가 중요할 때 쓴다.
- relaxed_order: 순서가 약간 뒤섞이더라도 리콜 확보를 최우선으로 한다.
