...
- **대규모 변경 수용도 (Large-scale Change)**: `8`
...
- **접근성/UX 엄격도 (A11y/UX Strictness)**: `6`
...
- **기술 부채 타협도 (Technical Debt Handling)**: `5`
...
- 기본 4개로 판단이 어려울 때는 `AGENTS.md`의 [판단 옵션](../../AGENTS.md#판단-옵션)을 참고한다.
