...
function printHelp(): void {
  console.log(`
📏 file-size-patterns.ts — 파일 크기 및 복잡도 검사

사용법:
  bun .vibe-coding/TOOLS/file-size-patterns.ts [경로] [옵션]
...
예시:
  bun .vibe-coding/TOOLS/file-size-patterns.ts              # src 전체 스캔
  bun .vibe-coding/TOOLS/file-size-patterns.ts src/lib      # 특정 디렉토리
  bun .vibe-coding/TOOLS/file-size-patterns.ts --all        # 전체 목록
  bun .vibe-coding/TOOLS/file-size-patterns.ts --json       # JSON 출력
