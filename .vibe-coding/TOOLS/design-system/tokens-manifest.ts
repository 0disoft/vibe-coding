...
function parseCssTokens(filePath: string, semanticColorsFromUno: string[]): TokenOccurrence[] {
...
function main(): void {
  ...
  const allOccurrences = sources.flatMap((p) => parseCssTokens(p, semanticColorsFromUno));
