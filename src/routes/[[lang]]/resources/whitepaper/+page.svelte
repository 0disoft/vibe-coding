...
<svelte:head>
  <title>화이트페이퍼 | {site.name}</title>
  <meta name="description" content="화이트페이퍼 - {site.name}" />
</svelte:head>
...
<div class="container py-12">
  <div class="mx-auto max-w-4xl space-y-6">
    <div class="space-y-2">
      ...
      <h1 class="text-h1 font-semibold">화이트페이퍼</h1>
    ...
    <DsCard class="space-y-3" padding="lg">
      ...
      <div class="text-body">
        <code class="text-code">/resources/whitepaper</code>
      </div>
