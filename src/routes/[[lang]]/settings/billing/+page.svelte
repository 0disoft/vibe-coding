...
<svelte:head>
  <title>결제 및 청구 관리 | {site.name}</title>
  <meta name="description" content="결제 및 청구 관리 - {site.name}" />
</svelte:head>
...
<div class="container px-4 py-12 md:px-6">
  <div class="mx-auto max-w-4xl space-y-6">
    <div class="space-y-2">
      ...
      <h1 class="text-h1 font-semibold">결제 및 청구 관리</h1>
    ...
    <DsCard class="space-y-3 p-6 md:p-8">
      ...
      <div class="text-body">
        <code class="text-code">/settings/billing</code>
      </div>
