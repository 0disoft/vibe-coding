...
<svelte:head>
  <title>서비스 수준 계약(SLA) | {site.name}</title>
  <meta name="description" content="서비스 수준 계약(SLA) - {site.name}" />
</svelte:head>
...
<div class="container px-4 py-12 md:px-6">
  <div class="mx-auto max-w-4xl space-y-6">
    <div class="space-y-2">
      ...
      <h1 class="text-h1 font-semibold">서비스 수준 계약(SLA)</h1>
