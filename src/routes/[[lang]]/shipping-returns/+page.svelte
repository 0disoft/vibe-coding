...
<svelte:head>
  <title>배송/반품 정책 | {site.name}</title>
  <meta name="description" content="배송/반품 정책 - {site.name}" />
</svelte:head>
...
<div class="container py-12">
  <div class="mx-auto max-w-4xl space-y-6">
    <div class="space-y-2">
      ...
      <h1 class="text-h1 font-semibold">배송/반품 정책</h1>
    ...
    <DsCard class="space-y-3" padding="lg">
      ...
      <div class="text-body">
        <code class="text-code">/shipping-returns</code>
      </div>
