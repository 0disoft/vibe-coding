...
<svelte:head>
  <title>지속가능성(ESG) | {site.name}</title>
  <meta name="description" content="지속가능성(ESG) - {site.name}" />
</svelte:head>
...
<div class="container py-12">
  <div class="mx-auto max-w-4xl space-y-6">
    <div class="space-y-2">
      ...
      <h1 class="text-h1 font-semibold">지속가능성(ESG)</h1>
