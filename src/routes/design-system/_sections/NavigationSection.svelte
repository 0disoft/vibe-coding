  ...
  const treeNodes = [
    {
      ...
      icon: "book-open",
      children: [
        { id: "overview", label: "Overview", description: "/docs", icon: "layout-dashboard" },
        {
          id: "getting-started",
          ...
          icon: "sparkles",
          children: [
            { id: "install", label: "Install", description: "/docs/getting-started#install" },
            { id: "first-run", label: "First run", description: "/docs/getting-started#run" },
          ],
        },
  ...
  <DsCard class="space-y-6">
    ...
    <DsTabs>
      ...
      <DsTabsContent value="overview">
        <p class="text-body-secondary text-muted-foreground">탭 컨텐츠 예시입니다.</p>
      </DsTabsContent>
      <DsTabsContent value="features">
        <p class="text-body-secondary text-muted-foreground">기능 목록을 탭으로 구성할 수 있습니다.</p>
      </DsTabsContent>
      <DsTabsContent value="billing">
        <p class="text-body-secondary text-muted-foreground">결제/청구 섹션 예시입니다.</p>
      </DsTabsContent>
    </DsTabs>
    ...
    <div class="space-y-2">
      ...
      <DsPagination page={pageNum} pageCount={24} onPageChange={(p) => (pageNum = p)} />
    </div>
