<script lang="ts">
  ...
  import type { PaymentContext, PaymentOption, PaymentSummaryItem } from "$lib/components/design-system";
  ...
  const paymentOptions = $derived.by<PaymentOption[]>(() => [
    {
      ...
      meta: [m.payment_option_card_meta_fee(), m.payment_option_card_meta_instant()],
      details: [m.payment_option_card_detail_3ds(), m.payment_option_card_detail_retry()],
      recommended: true,
    },
    {
      id: "kakao",
      ...
      meta: [m.payment_option_kakao_meta_fee(), m.payment_option_kakao_meta_mobile()],
      details: [
    ...
    },
    {
      ...
      meta: [m.payment_option_btc_meta_low_fees(), m.payment_option_btc_meta_onchain()],
      details: [
...
<section id="ds-commerce" class="space-y-6" aria-labelledby="commerce-title">
  ...
  <section class="space-y-4" aria-labelledby="commerce-main-demo">
    <DsCard class="space-y-6">
      <div class="grid gap-8 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
        <div class="space-y-4">
          <h3 id="commerce-main-demo" class="text-label text-muted-foreground font-semibold uppercase tracking-wider">
          ...
          />
          <p class="text-helper text-muted-foreground flex items-center gap-1.5" aria-live="polite">
        ...
        <div class="space-y-6">
          <section class="space-y-3" aria-labelledby="commerce-details-title">
            <h3 id="commerce-details-title" class="text-label text-muted-foreground font-semibold uppercase tracking-wider">
          ...
          <section class="space-y-3" aria-labelledby="commerce-summary-title">
            <h3 id="commerce-summary-title" class="text-label text-muted-foreground font-semibold uppercase tracking-wider">
  ...
  <section class="space-y-4" aria-labelledby="commerce-list-demo">
    <DsCard class="space-y-4">
      <div class="space-y-1">
        <h3 id="commerce-list-demo" class="text-label text-muted-foreground font-semibold uppercase tracking-wider">
